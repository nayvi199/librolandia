...
class SaleController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        return redirect()->back()->with('message','Libro agregado al carrito');
    }
    public function removeFromCart($specification_id)
    {
        $this->cart->remove($specification_id);
        return redirect()->back()->with('message','Libro removido del carrito');
    }
    public function viewCart()
    {
       ...
       //me manda a la ventana de productos
