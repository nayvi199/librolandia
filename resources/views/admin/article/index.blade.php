...
@section('header')
	Libros
	<a href="{{ url('admin/filecsv/format') }}" class="btn btn-primary"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Reporte de Libros XCV</a>

	<!--PARA IMPRIMIR UN PDF-->
	<a href="" class="btn btn-primary"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Reporte de Libros PDF</a>
	
	<a href="" data-toggle="modal" data-target=".bs-example-modal-lg"  class="btn btn-warning"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo Libro(+)</a>
@stop
@section('content')
...
<div class="panel panel-default">
	<div class="panel-body">
		<form action="{{ url('admin/products') }}" method="GET" class="form-inline" role="form">
			...
			<div class="form-group">
				<label class="sr-only" for="">Editorial</label>
		...
		@if ($products->isEmpty())
			<h4 style="text-align: center;">Sin Libros de esa editorial</h4>
		@endif
			...
			<form action="{{ url('admin/products') }}" method="POST" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data" style="display: block;">
				...
				<div class="modal-body">
					...
					<div class="form-group has-feedback {{ $errors->has('color_id')?'has-error ':''}}">
				    	<label class="col-sm-2 control-label" >Clasificacion(color):</label>
					    <div class="col-sm-10">
