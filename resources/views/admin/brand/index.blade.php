...
@stop
@section('header')
 <p style="color: #EF328E">Editorial</p>
	<a href="" data-toggle="modal" data-target=".bs-example-modal-lg"  class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true" style="background-color: #EF328E"></span> Nueva Editorial</a>
@stop
@section('content')
<!--Ver las editoriales, las marcas de libros-->
		...
		<div class="modal-content">
			<form action="{{ url('admin/brands') }}" method="POST" class="form-horizontal" ccept-charset="UTF-8" enctype="multipart/form-data" style="display: block;">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="gridSystemModalLabel">Nueva Editorial de Libros</h4>
				</div>
