<footer class="page-footer">
	<div class="container">
		<div class="row">
			<div class="col s12 m4">
				...
				<hr>
				<P ALIGN="justify">
				Somos unos integrantes del ITC de la Ingenieria en Sistemas, que buscamos crear paginas web que proveean de los beneficios mas solicitados en el mercado.</P>
			</div>
			<div class="col s12 m4">
			...
			<div class="col s12 m4">
				...
				<hr>
				<div>Chiquete Ibarra Naibi Irasema</div>
				<div>Salazar German</div>
				<div>Medina Aguilar Jorge</div>
			</div>
	...
	<div class="row center">
		<hr class="inline">
		<div class="inline">
			<b class="big-font">Libro-Landia</b>
			<br>
...
<div class="footer">
	<div class="container">
		<div class="footer-grids">
			...
			<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".6s">
				...
				<ul>
					...
					<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">librolandia@gmail.com</a></li>
		...
		<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
			<h2><a href="{{url ('/')}}">Libro - Landia <span>Todo lo libros que necesites a tu alcance y en un clic.</span></a></h2>
		</div>
		<div class="copy-right animated wow slideInUp" data-wow-delay=".5s">
			<p>&copy 2017 Libro - Landia. Derechos Reservados></p>
		</div>
	</div>
</div>
