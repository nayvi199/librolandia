...
Route::get('filecsv/imprimir','FileCsvController@imprimir');
...
Route::get('admin/user/form_nuevo_usuario', 'UserController@form_nuevo_usuario');
//Auth::routes();

//regresar a la pestaña normal
